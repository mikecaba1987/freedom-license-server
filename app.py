...
def generate_license_key():
    ...
    for _ in range(4):
        parts.append(secrets.token_hex(3).upper())
...
@app.route("/admin/create-license", methods=["GET"])
def create_license():
    init_db()
...
def check():
    ...
    cur.execute("""
        ...
        FROM licenses
        JOIN activations
        ON licenses.license_key = activations.license_key
